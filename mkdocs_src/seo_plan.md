...
* **Robots.txt**: GitHub Pages ne crea uno di default, ma per un controllo fine si può creare un file `docs/robots.txt` personalizzato (spesso non necessario se non si vogliono
  bloccare path specifici).
