...
1.  **`dev.sh`**: The main helper script for development and maintenance. It provides shortcuts for common tasks like running tests, managing the database, and building the frontend.
