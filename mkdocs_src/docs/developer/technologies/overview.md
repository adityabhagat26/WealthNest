...
-   **[Pydantic](https://docs.pydantic.dev/)**: A data validation and settings management library. It is used extensively for defining data schemas, validating API requests, and managing application settings.
...
-   **[SQLite](https://www.sqlite.org/)**: The default database engine. It is simple, serverless, and perfect for a self-hosted application. The database is configured to run in WAL (Write-Ahead Logging) mode for better concurrency.

## Frontend

-   **[SvelteKit](https://kit.svelte.dev/)**: A web application framework for building fast, modern user interfaces. It provides server-side rendering (SSR), routing, and a great developer experience.
