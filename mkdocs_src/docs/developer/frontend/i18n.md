...
LibreFolio supports multiple languages to ensure accessibility for a global audience. The frontend uses **[svelte-i18n](https://github.com/kaisermann/svelte-i18n)** for managing translations and locale switching.
