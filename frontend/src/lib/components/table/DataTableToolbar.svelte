...
<script lang="ts">
    ...
    import {ChevronDown, ChevronUp, Eye, EyeOff, GripVertical, RotateCcw} from 'lucide-svelte';
...
<style>
    ...
    :global(.dark) .column-option.dragging {
        background: #475569;
    }

    :global(.dark) .column-option.drag-over {
    ...
    :global(.dark) .col-visibility-icon {
        color: #94a3b8;
    }
    ...
    :global(.dark) .col-drag {
        color: #475569;
    }

    :global(.dark) .col-drag:hover {
        color: #94a3b8;
    }
    ...
    :global(.dark) .reorder-btn {
        background: #334155;
        color: #94a3b8;
    }

    :global(.dark) .reorder-btn:hover:not(:disabled) {
        background: #475569;
        color: #f1f5f9;
    }
